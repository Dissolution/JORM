...
namespace JORM
{
    ...
    {
        public static bool operator ==(RawString x, RawString y) => string.Equals(x._string, y._string);
        public static bool operator !=(RawString x, RawString y) => !string.Equals(x._string, y._string);
        public static bool operator ==(RawString x, string? y) => string.Equals(x._string, y);
        public static bool operator !=(RawString x, string? y) => !string.Equals(x._string, y);
        ...
        public ReadOnlySpan<char> Chars => (ReadOnlySpan<char>)_string;
        ...
        public bool Equals(string? str) => string.Equals(_string, str);

        public bool Equals(RawString nfs) => string.Equals(_string, nfs._string);
        ...
        /// <inheritdoc />
        public override int GetHashCode() => string.GetHashCode(_string);
